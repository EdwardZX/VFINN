...
def get_pred_gt_flow(model,filepath, filename, model_name, img_format = '.tif',
                            ...
                            save_plot_path = './plot_bsa2nd_png',
                            is_spt = None):
    # filename = SQG_00001
...
if __name__ == "__main__":
    ...
    ## can give a dict
    filenames = {
    # 'BSA_NaAc_Kcl_0mM_res_piv': 'BSA_0mM_kcl_100mM_NaAc',
    # 'BSA_NaAc_50_mM_res_0001_piv': 'BSA_50mM_kcl_100mM_NaAc',
    # 'BSA_NaAc_50_mM_res_0002_piv': 'BSA_50mM_kcl_100mM_NaAc',
    # 'BSA_NaAc_50_mM_res_piv': 'BSA_50mM_kcl_100mM_NaAc',
    # 'BSA_NaAc_50_mM_res02_piv': 'BSA_50mM_kcl_100mM_NaAc',
    # 'BSA_KCl_200mM_F_res_0001_piv': 'BSA_200mM_kcl_5mg_F',
    # 'BSA_KCl_200mM_F_res_0002_piv': 'BSA_200mM_kcl_5mg_F',
    # 'BSA_KCl_200mM_F_res_0003_piv': 'BSA_200mM_kcl_5mg_F',
    # 'BSA_KCl_200mM_F_res_0004_piv': 'BSA_200mM_kcl_5mg_F',
    # 'BSA_KCl_200mM_F_res_0005_piv': 'BSA_200mM_kcl_5mg_F',
    # 'BSA_KCl_200mM_F_res_0006_piv': 'BSA_200mM_kcl_5mg_F',
    # 'BSA_KCl_200mM_F_res_piv': 'BSA_200mM_kcl_5mg_F',
    # 'BSA_KCl_400mM_HA_0004_piv': 'BSA_400mM_kcl_5e-1mg_HA',
    'BSA_KCl_400mM_HA_res_0002_piv': 'BSA_400mM_kcl_5e-1mg_HA',
    'BSA_KCl_400mM_F_res_0001_piv': 'BSA_400mM_kcl_5mg_F',
    'BSA_KCl_400mM_F_res_0002_piv': 'BSA_400mM_kcl_5mg_F',
    'BSA_KCl_400mM_F_res_0003_piv': 'BSA_400mM_kcl_5mg_F',
    'BSA_KCl_400mM_F_res_0004_piv': 'BSA_400mM_kcl_5mg_F',
    'BSA_KCl_400mM_F_res_0005_piv': 'BSA_400mM_kcl_5mg_F',
}
    
    # filenames = {'bsa_qd_30_kcl_0006_piv': 'BSA_400mM_kcl',}
    datapath = './assets/piv_bsa2nd_samples/'
